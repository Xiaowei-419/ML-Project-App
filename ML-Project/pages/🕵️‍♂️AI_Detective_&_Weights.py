...
with sim_col2:
    ...
    if score > 60:
        ...
        st.info("✨ **What's happening here:** Low screen time mixed with mindful, selective swiping shows true intent. The data confirms this thoughtful approach yields the highest success rate for transforming into a meaningful real-life connection.")
    else:
...
st.subheader("💡 The Bottom Line: Tips to Success")
